...
export default class HeaderMessages extends React.Component {
  ...
  componentDidMount(){
    var messages = [{
      ...
      displayPicture: '/home/cortana/Projects/JSProjects/gobbledigook/public/dist/img/user3-128x128.jpg',
      content: 'Why not buy a new awesome theme?',
      time: '2 hours',
    }, {
      title: 'Developers',
      displayPicture: '/home/cortana/Projects/JSProjects/gobbledigook/public/dist/img/user4-128x128.jpg',
      content: 'Why not buy a new awesome theme?',
      time: 'Today',
    }, {
